...
import com.example.intifoodapp.adapters.MyCartAdapter;
...
public class myCartFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        orderNow = root.findViewById(R.id.buy);
        ...
        db.collection("CurrentUser").document(auth.getCurrentUser().getUid())
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    calculateTotalPrice(cartModelList);
                }
            }
        });
    ...
    private void calculateTotalPrice(List<MyCartModel> cartModelList) {
        double totalPrice = 0.0;
        for(MyCartModel myCartModel : cartModelList){
            totalPrice += myCartModel.getTotalPrice();
        }

        totalAmount.setText("Total Amount: RM " + totalPrice);
    }
